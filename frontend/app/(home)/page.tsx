          ...
          <Link href={`/post/${posts[0].slug}`}>
            <div className="flex flex-col-reverse md:flex-row rounded-2xl overflow-hidden shadow-lg bg-white md:bg-[#214E4E]">
              ...
              <div className="p-6 flex flex-col justify-center lg:w-1/2">
                ...
                <span className={`inline-block ${getRandomColor()} text-xs font-semibold px-3 py-1 rounded-full w-fit mb-3`}>
                  {posts[0].category.name}
                </span>
                <h2 className="text-lg md:text-2xl font-bold mt-2 text-[#214E4E] md:text-[#ededed]">
                  {posts[0].title}
                </h2>
                <p className="text-gray-600 md:text-gray-300 mt-2">{posts[0].description}</p>
                ...
                <div className="flex items-center gap-3 mt-6">
                  ...
                  */}
                  ...
                  />
                  <span className="text-sm text-gray-700 md:text-gray-300">By {posts[0].author.name}</span>
                </div>
              </div>
